...
import org.wildfly.swarm.microprofile_metrics.runtime.app.Clock;
import org.wildfly.swarm.microprofile_metrics.runtime.app.Reservoir;
...
public class SlidingTimeWindowArrayReservoir implements Reservoir {
    ...
    /**
     * Creates a new {@link com.codahale.metrics.SlidingTimeWindowArrayReservoir} with the given window of time.
     *
    ...
    /**
     * Creates a new {@link com.codahale.metrics.SlidingTimeWindowArrayReservoir} with the given clock and window of time.
     *
     * @param window     the window of time
     * @param windowUnit the unit of {@code window}
